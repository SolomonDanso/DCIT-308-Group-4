...
public class CustomerForm extends javax.swing.JPanel {
    ...
    private void updateTable() {
        ...
        Map<String, Sales> salesMap = DatabaseHelper.getAllSales();

         List<Sales> sales = new ArrayList<>(salesMap.values());

         SaleIterable saleIterable = new SaleIterable(sales);

        // Iterate over the drugs and add rows to the table model
        for (Sales sale : saleIterable) {
